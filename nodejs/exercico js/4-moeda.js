...
// valor em forma de texto e utilizando virgula
...
console.log("O valor convertido é de : R$ " + converterParaReal(transacao.valor));

const valorFinal = converterParaReal(transacao.valor);
// colocar true e false no lugar de sim e não
if (transacao.concluida == true) 
  {
  console.log("O valor convertido para " + transacao.usuario + " é: " + valorFinal);
  }

// if no lugar do else, e não e tem parentese com informação no else
else{
